...
// ReadOne is a stub to satisfy the CRUDable interface
func (td *TaskDuplicate) ReadOne(_ *xorm.Session, _ web.Auth) error { return nil }

// ReadAll is a stub to satisfy the CRUDable interface
func (td *TaskDuplicate) ReadAll(_ *xorm.Session, _ web.Auth, _ string, _ int, _ int) (interface{}, int, int64, error) {
	return nil, 0, 0, nil
}

// Update is a stub to satisfy the CRUDable interface
func (td *TaskDuplicate) Update(_ *xorm.Session, _ web.Auth) error { return nil }

// Delete is a stub to satisfy the CRUDable interface
func (td *TaskDuplicate) Delete(_ *xorm.Session, _ web.Auth) error { return nil }
