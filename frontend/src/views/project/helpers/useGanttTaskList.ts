...
export interface UseGanttTaskListReturn {
	...
	onCascadePrompt: Ref<((info: {label: string, names: string, absDays: number, direction: string, accentColor: string, action: () => void, barId?: string}) => void) | null>
}
...
export function useGanttTaskList<F extends Filters>(
	...
	const onCascadePrompt = ref<((info: {label: string, names: string, absDays: number, direction: string, accentColor: string, action: () => void, barId?: string}) => void) | null>(null)
